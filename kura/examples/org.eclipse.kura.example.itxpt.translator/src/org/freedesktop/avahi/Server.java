...
public interface Server extends DBusInterface {
    ...
    public DBusPath ServiceResolverNew(int interfaceparam, int protocol, String name, String type, String domain,
            int aprotocol, UInt32 flags);
    ...
    public DBusPath RecordBrowserNew(int interfaceparam, int protocol, String name, UInt16 clazz, UInt16 type,
            UInt32 flags);
