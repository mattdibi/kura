...
public interface Server2 extends DBusInterface {
    ...
    public DBusPath ServiceResolverPrepare(int interfaceparam, int protocol, String name, String type, String domain, int aprotocol, UInt32 flags);
    ...
    public DBusPath RecordBrowserPrepare(int interfaceparam, int protocol, String name, UInt16 clazz, UInt16 type, UInt32 flags);
