...
public interface ServiceResolver extends DBusInterface {
    ...
    public static class Found extends DBusSignal {
        ...
        public Found(String _path, int _interface, int _protocol, String _name, String _type, String _domain,
                String _host, int _aprotocol, String _address, UInt16 _port, List<List<Byte>> _txt, UInt32 _flags)
                throws DBusException {
            super(_path, _interface, _protocol, _name, _type, _domain, _host, _aprotocol, _address, _port, _txt,
                    _flags);
